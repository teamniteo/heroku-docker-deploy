...
const core = __importStar(__webpack_require__(496));
const login_to_heroku_1 = __webpack_require__(558);
const build_docker_image_1 = __webpack_require__(955);
const push_docker_container_1 = __webpack_require__(245);
const release_docker_container_1 = __webpack_require__(185);
const assert_1 = __importDefault(__webpack_require__(357));
const utils_1 = __webpack_require__(923);
...
const utils_1 = __webpack_require__(433);
...
Object.defineProperty(exports, "__esModule", { value: true });
const command_1 = __webpack_require__(689);
const file_command_1 = __webpack_require__(482);
const utils_1 = __webpack_require__(433);
const os = __importStar(__webpack_require__(87));
...
const core = __importStar(__webpack_require__(496));
const utils_1 = __webpack_require__(923);
exports.loginToHeroku = ({ herokuApiKey, cwd }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        core.startGroup('Logging into the Heroku docker registry...');
        const data = yield utils_1.exec(`echo ${herokuApiKey} | docker login --username=_ registry.heroku.com --password-stdin`, { cwd });
